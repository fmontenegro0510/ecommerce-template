		...
		<div className="grid grid-cols-12">
				  <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
					  <div className="space-y-2">
						  <h2 className="text-4xl font-bold leadi lg:text-5xl">Sign up for our newsletter</h2>
						  <div className="dark:text-gray-400 text-xs">Be the first to know about our special offers, new product launches, and events</div>
					  </div>
					  <div className="mt-2">						  
					  <input id="name" type="text" placeholder="Email Address" className="w-2/3 p-3 rounded dark:bg-gray-800" />
