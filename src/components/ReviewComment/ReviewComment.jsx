...
function ReviewComment() {
  return (
    ...
    <ul className="my-10 mx-auto max-w-screen-md px-10 py-16">
  <li className="py-8 text-left border px-4 m-2">
    <div className="flex items-start">
      ...
      <div className="ml-6">
        ...
        <p className="mt-5 text-base text-gray-900  flex justify-end">October 21, 2020</p>
        <p className="mt-5 text-base text-gray-900  flex justify-Start">PedroPicaPiedras</p>
